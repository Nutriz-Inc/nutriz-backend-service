...
type RouteDonationStep struct {
	...
	Status              EnumRouteDonationStepStatus `json:"status" db:"status"`
...
type EnumRouteDonationStepStatus string

const (
	EnumRouteDonationStepStatusPending    EnumRouteDonationStepStatus = "pending"
	EnumRouteDonationStepStatusInProgress EnumRouteDonationStepStatus = "in_progress"
	EnumRouteDonationStepStatusDone       EnumRouteDonationStepStatus = "done"
	EnumRouteDonationStepStatusError      EnumRouteDonationStepStatus = "error"
)
